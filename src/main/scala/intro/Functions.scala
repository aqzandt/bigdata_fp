...
object Functions {
  ...
  val isEven = (i: Int) => if (i % 2 == 0) true else false // tells whether given Int is even or not
  val isOdd = (i: Int) => if (i % 2 == 1) true else false // same but this time if it's odd
